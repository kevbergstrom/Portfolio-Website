...
clickToggleElement(document.getElementById('navButton'), document.getElementById('navMenu'))
...
function main(){
    ...
    const nameCheckbox = generateCheckbox({
        title: 'Toggle Name',
        checked: true,
        callback: val => { 
            const heroText = document.getElementById('heroText')
            heroText.style.opacity = val*1
         }
    })
